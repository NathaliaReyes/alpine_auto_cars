    ...
    <div className='navbar-image-container'>
      <nav className={navbarClass()}>
        <div className="flex items-center flex-shrink-0 text-black">
          ...
          <span className='md:block hidden font-bold lg:text-2xl md:text-base sm:text-sm text-xs tracking-tight text-shadow roboto600 ' id="nav-name">Alpine Auto Sales, LLC.</span>
        </div>
        {Auth.loggedIn() && (
          <>
        ...
        <div className={`w-full ${isActive ? 'block' : 'hidden'} md:flex md:items-center md:w-auto`} id="navMenu">
          <div className="lg:text-lg md:text-base sm:text-sm md:flex-grow ml-1 roboto600">

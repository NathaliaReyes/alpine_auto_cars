...
function AboutUs() {
  ...
  return (
    <div className='p-5'>
      ...
      <p style={{ lineHeight: '1.5' }} className="text-neutral-400 max-w-lg mx-auto my-2 lg:text-base md:text-sm text-center relative z-10">
      ...
      <p style={{ lineHeight: '1.5' }} className="text-neutral-400 max-w-lg mx-auto my-2 lg:text-base md:text-sm text-center relative z-10 hidden md:block">
